...
class User:
    ...
    def new_profile(self, name,last_name,age,passport): #метод класса User
        self.profile = Profile(name, last_name, age,passport) #экземпляр класса профиль

    def your_adress(self, city,street,zipcode):
        self.adress.append(Address(city, street, zipcode))

user1 = User()
user1.new_profile('Катя', 'Муратова', 20, 23223453)
user1.your_adress('Мухосранск', 'Ленин', 12434)
user1.your_adress('Улица Пушкина',"Дом Калатушкина",123123)
